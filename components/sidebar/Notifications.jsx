...
const Notifications = () => {
  ...
  const notifications = ['PID is arriving tomorrow', 'PID is on a discounted rate', 'PID is on a discounted rate', 'PID arriving Wednesday']
    ...
    <div className='flex'>
      ...
      >
        <div className='flex justify-end'>
            ...
            {notifications.length && <div className='w-4 h-4 rounded-full bg-red-600 flex items-center p-0.5'>{notifications.length}</div> || ''}
        </div>
