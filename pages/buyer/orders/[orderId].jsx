  ...
  return (
    <Page name={`Order Details`}>
      ...
      <div className="flex flex-col lg:grid grid-cols-[60%_38%] grid-flow-col justify-between">
        <div>
          {(order.product && (
            <div className="bg-dimmed-black rounded-md p-3 flex flex-col justify-around md:flex-row text-lg font-semibold text-brand-lavender h-full">
              ...
              <div className="p-1 text-green-400 flex flex-col justify-evenly">
                ...
                <h1 className="font-medium text-sm sm:text-base flex justify-between  p-2">
                  ...
                  <p>₹{order?.shippingPriceEth.toNumber()}</p>
                </h1>
