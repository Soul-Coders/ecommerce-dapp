...
const Dashboard = () => {
  ...
  const greet = hrs < 12 && 'Good morning' || hrs >= 12 && hrs <= 17 && 'Good afternoon' || 'Good evening'
  ...
  return (
    <Page name={'Dashboard'}>
      ...
      <div className='flex font-bold text-base md:text-2xl gap-1 items-center'>
        <p>{greet}</p>
        <h1
          class="font-extrabold text-transparent bg-clip-text bg-gradient-to-tr from-brand-purple to-brand-red"
        >
          {currentAccount.info.name && currentAccount.info.name.split(' ')[0] || 'Alex'}
        </h1>
        <p>!</p>
      </div>
      ...
      <div className='flex justify-between'>
        <h1 className='mt-4 mb-1 text-base font-bold md:text-xl'>You might be looking for</h1>
        <Link 
          href={'/buyer/products'}
      ...
      {/* From your watchlist */}
      <h1 className='mt-4 mb-1 text-base font-bold md:text-xl'>Your watchlist</h1>

      {/* Active orders / Orders */}
      <h1 className='mt-4 mb-1 text-base font-bold md:text-xl'>Arriving Soon</h1>
      <List
        colnames={[]}
      >
